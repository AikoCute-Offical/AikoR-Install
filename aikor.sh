...
#using aikor.sh -host<apihost> -key<apikey> -nodetype<nodetype> -nodeid<nodeid> 
...
wget https://raw.githubusercontent.com/AikoCute-Offical/AikoR-Install/en/install.sh -O install.sh && chmod +x install.sh && ./install.sh
rm -rf install.sh
rm -rf /etc/AikoR/aiko.yml

# Generate config file
cat > /etc/AikoR/aiko.yml << EOF
Log:
